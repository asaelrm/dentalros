...
test('Roles, precios no manipulables, cantidades, historial y respaldos del catálogo', async t => {
  ...
  const charge = await f.request(`/api/consultas/${visit.data.id}/charge`, 'POST', { payments: [{ method: 'efectivo', amount: 20 }, { method: 'tarjeta', amount: 30, cardBrand: 'Visa', cardType: 'Crédito', lastFour: '1234', authorizationNumber: '458721' }], reference: 'APROB-1', coveragePercent: 25, amountReceived: 50 }, sessions.secretaria);
